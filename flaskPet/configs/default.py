# -*- coding: utf-8 -*-
"""
    flaskpet.configs.default
    ~~~~~~~~~~~~~~~~~~~~~~~

    This is the default configuration for FlaskPet that every site should have.
...
class DefaultConfig(object):
    ...
    #            <_basedir>
    # ../../ -->  flaskpet/flaskpet/configs/base.py
    ...
    # Example for the FlaskPet forums: SERVER_NAME = "forums.flaskpet.org"
    #SERVER_NAME =
    ...
    # If None this defaults to flaskpet/logs
    #
    ...
    LOG_DEFAULT_CONF = {
        ...
        'handlers': {
            ...
            'flaskpet': {
                ...
                'filename': os.path.join(LOG_PATH, 'flaskpet.log'),
                'mode': 'a',
    ...
    # FlaskPet logging configuration which uses the settings
    ...
    # ------------------------------
    # For PostgresSQL:
    #SQLALCHEMY_DATABASE_URI = "postgresql://flaskpet@localhost:5432/flaskpet"
    # For SQLite:
