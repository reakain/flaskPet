...
class UserValidator(ABC):
    ...
    by raising a :class:`~flaskpet.core.exceptions.ValidationError`.
    """
    ...
    def validate(self, user_info):
        ...
        :type user_info: :class:`~flaskpet.core.auth.registration.UserRegistrationInfo`
        """  # noqa
...
class RegistrationPostProcessor(ABC):
    ...
    def post_process(self, user):
        ...
        :type user: :class:`~flaskpet.user.models.User`
        """
        pass
