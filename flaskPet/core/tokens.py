# -*- coding: utf-8 -*-
"""
    flaskpet.core.auth.tokens
    ~~~~~~~~~~~~~~~~~~~~~~~~

    This module provides ways of interacting
    with tokens in FlaskPet

    :copyright: (c) 2014-2018 by the FlaskPet Team.
...
class TokenError(BaseFlaskPetError):
    """
...
class TokenActions:
    ...
    .. note::
        ...
        to the ones implemented by FlaskPet itself and block extension of
        tokens by plugins.
    """
...
class Token(object):
    ...
    :param str operation: An operation taken from
        :class:`TokenActions<flaskpet.core.tokens.TokenActions>`
    """
    user_id = attr.ib()
    operation = attr.ib()
...
class TokenSerializer(ABC):
    ...
    def dumps(self, token):
        ...
        :param token:
        :type token: :class:`Token<flaskpet.core.tokens.Token>`
        :returns str:
        """
        pass
    ...
    def loads(self, raw_token):
        ...
        actual :class:`Token<flaskpet.core.tokens.Token>` instance

        :param str raw_token:
        :returns token: The parsed token
        :rtype: :class:`Token<flaskpet.core.tokens.Token`>
        """
        pass
...
class TokenVerifier(ABC):
    ...
    Should raise a
    :class:`ValidationError<flaskpet.core.exceptions.ValidationError>`
