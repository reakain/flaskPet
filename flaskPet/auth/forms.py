...
from flaskpet.utils.fields import RecaptchaField
from flaskpet.utils.forms import FlaskPetForm
...
class RegisterForm(FlaskPetForm):
...
class ForgotPasswordForm(FlaskPetForm):
    email = StringField(
        _("Email address"),
        validators=[
            DataRequired(message=_("A valid email address is required.")),
...
class ResetPasswordForm(FlaskPetForm):
...
class RequestActivationForm(FlaskPetForm):
    username = StringField(
        _("Username"),
        validators=[
            DataRequired(message=_("A valid username is required.")),
...
class AccountActivationForm(FlaskPetForm):
    token = StringField(
