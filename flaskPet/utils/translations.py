# -*- coding: utf-8 -*-
"""
    flaskpet.utils.translations
    ~~~~~~~~~~~~~~~~~~~~~~~~~~

    This module contains the translation Domain used by FlaskPet.
...
class FlaskPetDomain(Domain):
    def __init__(self, app):
        self.app = app
        super(FlaskPetDomain, self).__init__()

        # Plugin translations
        with self.app.app_context():
            self.plugin_translations = \
                self.app.pluggy.hook.flaskpet_load_translations()
