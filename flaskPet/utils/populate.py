...
from flaskpet.extensions import alembic, db
from flaskpet.forum.models import Category, Forum, Post, Topic
from flaskpet.management.models import Setting, SettingsGroup
from flaskpet.user.models import Group, User
...
def create_default_settings():
    ...
    from flaskpet.fixtures.settings import fixture
    create_settings_from_fixture(fixture)


def create_default_groups():
    """This will create the 5 default groups."""
    from flaskpet.fixtures.groups import fixture
    result = []
...
def create_welcome_forum():
    ...
    post = Post(content="Have fun with your new FlaskPet Forum!")
