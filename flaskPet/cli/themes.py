...
from flaskpet.cli.utils import get_cookiecutter, validate_theme
...
def list_themes():
    ...
    active_theme = get_theme(flaskpet_config['DEFAULT_THEME'])
...
def new_theme(template, out_dir, force):
    ...
    https://github.com/sh4nks/cookiecutter-flaskpet-theme.
