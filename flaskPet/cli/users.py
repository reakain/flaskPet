...
from flaskpet.cli.utils import FlaskPetCLIError, EmailType, prompt_save_user
...
def new_user(username, email, password, group):
    ...
    try:
        ...
        raise FlaskPetCLIError("Couldn't create the user because the "
...
def change_user(username, email, password, group):
    ...
    if user is None:
        raise FlaskPetCLIError("The user with username {} does not exist."
