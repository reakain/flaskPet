...
def flaskpet_jinja_directives(app):
    render_classes = app.pluggy.hook.flaskpet_load_post_markdown_class(app=app)
    app.jinja_env.filters['markup'] = make_renderer(render_classes)

    render_classes = app.pluggy.hook.flaskpet_load_nonpost_markdown_class(
        app=app
    )
...
def make_renderer(classes):
    RenderCls = type('FlaskPetRenderer', tuple(classes), {})
