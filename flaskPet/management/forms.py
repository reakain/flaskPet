...
from flaskpet.forum.models import Category, Forum
from flaskpet.user.models import Group, User
from flaskpet.utils.fields import BirthdayField
from flaskpet.utils.helpers import check_image
from flaskpet.utils.requirements import IsAtleastModerator
...
class ForumForm(FlaskForm):
    ...
    external = StringField(
        ...
        description=_("A link to a website i.e. 'http://flaskpet.org'.")
    )
