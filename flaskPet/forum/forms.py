...
from flaskpet.forum.models import Topic, Post, Report, Forum
...
class ReplyForm(FlaskForm):
    ...
    def save(self, user, topic):
        ...
        current_app.pluggy.hook.flaskpet_form_new_post_save(form=self)
        return post.save(user=user, topic=topic)
...
class NewTopicForm(ReplyForm):
    ...
    def save(self, user, forum):
        ...
        current_app.pluggy.hook.flaskpet_form_new_topic_save(form=self,
                                                            topic=topic)
